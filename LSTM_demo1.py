...
def lstm(X_train, Y_train, X_test, Y_test, num_class, batch_size, epochs):
    ...
    history = lstm.fit(X_train, Y_train, batch_size=batch_size, epochs=epochs, validation_data=(X_test, Y_test),
...
if __name__ == '__main__':
    lstm(X_train, Y_train, X_test, Y_test, num_class=2, batch_size=512, epochs=80)
